...
const NItoPbmt1 = () => {
  const showferry = () =>{
    ...
    document.getElementById("selectbtnnautikamt").style.display = "none";
    document.getElementById("nautikapricemt").style.display = "none";
    document.getElementById("ferrydetailmt1").style.display = "block";
    document.getElementById("selectbtngreenoceanmt").style.display = "block";
    document.getElementById("pricegreenoceanmt").style.display = "block";
    document.getElementById("greenoceanferrydetailmt1").style.display = "none";
  }

  const hideferry = () =>{
    // hiding the ferry details
    document.getElementById("selectbtnnautikamt").style.display = "block";
    document.getElementById("nautikapricemt").style.display = "block";
    document.getElementById("ferrydetailmt1").style.display = "none";
  }
  ...
  const Travellersdetail1 = () =>{
      ...
      document.getElementById("mt2").style.display = "block";
      document.getElementById("multitrip1").style.backgroundColor = "hsl(0, 1%, 80%)";
      document.getElementById("multitrip2").style.backgroundColor = "white";
  }
  ...
  const amenities = (e) => {
    ...
    if(selectedamenities === "Business"){
      document.getElementById("amenities-Businessmt1").style.display = "block";
      document.getElementById("amenities-Premiummt1").style.display = "none";
      document.getElementById("amenities-Luxurymt1").style.display = "none";
      document.getElementById("amenities-Royalmt1").style.display = "none";
      document.getElementById("amenities-Economymt1").style.display = "none";
    }

    if(selectedamenities === "Premium"){
      document.getElementById("amenities-Premiummt1").style.display = "block";
      document.getElementById("amenities-Businessmt1").style.display = "none";
      document.getElementById("amenities-Luxurymt1").style.display = "none";
      document.getElementById("amenities-Royalmt1").style.display = "none";
      document.getElementById("amenities-Economymt1").style.display = "none";
    }
    ...
    if(selectedamenities === "Economy"){
      document.getElementById("amenities-Economymt1").style.display = "block";
      document.getElementById("amenities-Luxurymt1").style.display = "none";
      document.getElementById("amenities-Royalmt1").style.display = "none";
      document.getElementById("amenities-Premiummt1").style.display = "none";
      document.getElementById("amenities-Businessmt1").style.display = "none";
    ...
    if(selectedamenities === "Royal"){
      document.getElementById("amenities-Royalmt1").style.display = "block";
      document.getElementById("amenities-Luxurymt1").style.display = "none";
      document.getElementById("amenities-Economymt1").style.display = "none";
      document.getElementById("amenities-Premiummt1").style.display = "none";
      document.getElementById("amenities-Businessmt1").style.display = "none";
    ...
    if(selectedamenities === "Luxury"){
      document.getElementById("amenities-Luxurymt1").style.display = "block";
      document.getElementById("amenities-Royalmt1").style.display = "none";
      document.getElementById("amenities-Economymt1").style.display = "none";
      document.getElementById("amenities-Premiummt1").style.display = "none";
      document.getElementById("amenities-Businessmt1").style.display = "none";
  ...
  const showferrygreenocean = () =>{
    // Disabling the select ferry btn and price tag and displaying ferry details
    document.getElementById("selectbtngreenoceanmt").style.display = "none";
    document.getElementById("pricegreenoceanmt").style.display = "none";
    document.getElementById("greenoceanferrydetailmt1").style.display = "block";
    document.getElementById("selectbtnnautikamt").style.display = "block";
    document.getElementById("nautikapricemt").style.display = "block";
    document.getElementById("ferrydetailmt1").style.display = "none";
  }
          ...
          <div className='row ferrydetail' style={{marginTop:"5%"}}> 
            ...
            <div className='container'>
              ...
              <div className='row'>
                ...
                <div className='col-5' id='nautikapricemt' style={{display:"block"}}>
              ...
              <div className='row'>
                ...
                <div className='col-4 col-md-4' id='selectbtnnautikamt' style={{display:"block"}}>
              ...
              <div className='row' id='ferrydetailmt1' style={{display:"none"}}>
                <div className='container'>
                  <div className='row'>
                  ...
                  <div className='row' style={{marginTop:"2%"}}>
                    <div className="booking-details-amenities pad-3" id="amenities-Premiummt1" style={{display:"none", marginBottom:"2%"}}>
                      <h4> Amenities <strong className="font-italic">- <span className="seat-type brand-secondary">Premium</span> </strong></h4>
                      <ul className="amenities-Premiummt1 justify-content-between align-items-center flex-wrap no-padding no-margin-bottom active">
                    ...
                    <div className="booking-details-amenities pad-3" id="amenities-Businessmt1" style={{display:"none", marginBottom:"2%"}}>
                      <h4> Amenities <strong className="font-italic">- <span className="seat-type brand-secondary">Business</span> </strong></h4>
                      <ul className="amenities-Businessmt1 justify-content-between align-items-center flex-wrap no-padding no-margin-bottom active">
                        <li className="active am-pci">High-Speed Ferry</li>
                        <li className="active am-fr">Air Conditioned</li>
                        <li className="active am-ecs">Cafeteria</li>
                        <li className="active am-pv">Premium Seating</li>
          ...
          <div className='row ferrydetail' style={{marginTop:"5%"}}> 
            ...
            <div className='container'>
                ...
                <div className='row'>
                    ...
                    <div className='col-5' id='pricegreenoceanmt' style={{display:"block"}}>
                ...
                <div className='row'>
                  ...
                  <div className='col-4' id='selectbtngreenoceanmt' style={{display:"block"}}>
                ...
                <div className='row' id='greenoceanferrydetailmt1' style={{display:"none"}}>
                  <div className='container'>
                    <div className='row'>
                      <div className="slider" style={{marginLeft:"-3%"}}>
                        <button className="arrow arrow-left" onClick={goToPreviousImage}>
                    ...
                    <div className='row' style={{marginTop:"2%"}}>
                      <div className="booking-details-amenities pad-3" id="amenities-Economymt1" style={{display:"none", marginBottom:"2%"}}>
                      ...
                      <div className="booking-details-amenities pad-3" id="amenities-Luxurymt1" style={{display:"none", marginBottom:"2%"}}>
                      ...
                      <div className="booking-details-amenities pad-3" id="amenities-Royalmt1" style={{display:"none", marginBottom:"2%"}}>
