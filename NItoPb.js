...
const NItoPb = () => {
  const showferry = () =>{
    ...
    document.getElementById("selectbtn1").style.display = "none";
    document.getElementById("ferrydetail").style.display = "block";
    document.getElementById("selectbtngreenocean").style.display = "block";
    document.getElementById("pricegreenocean").style.display = "block";
    document.getElementById("greenoceanferrydetail").style.display = "none";
  }

  const hideferry = () =>{
    // hiding the ferry details
    document.getElementById("selectbtn").style.display = "block";
    document.getElementById("selectbtn1").style.display = "block";
    document.getElementById("ferrydetail").style.display = "none";
  }

  const Travellersdetail1 = () =>{
    // hiding current page and displaying Travellers Details form page
    document.getElementById("selectonewayferry").style.display = "none";
    document.getElementById("show").style.display = "block";
    document.getElementById("selectroundtripferry").style.display = "none";
  }
  ...
  const amenities = (e) => {
    ...
    if(selectedamenities === "Business"){
      document.getElementById("amenities-Business").style.display = "block";
      document.getElementById("amenities-Premium").style.display = "none";
      document.getElementById("amenities-Luxury").style.display = "none";
      document.getElementById("amenities-Royal").style.display = "none";
      document.getElementById("amenities-Economy").style.display = "none";
    }

    if(selectedamenities === "Premium"){
      document.getElementById("amenities-Premium").style.display = "block";
      document.getElementById("amenities-Business").style.display = "none";
      document.getElementById("amenities-Luxury").style.display = "none";
      document.getElementById("amenities-Royal").style.display = "none";
      document.getElementById("amenities-Economy").style.display = "none";
    }
    ...
    if(selectedamenities === "Economy"){
      document.getElementById("amenities-Economy").style.display = "block";
      document.getElementById("amenities-Luxury").style.display = "none";
      document.getElementById("amenities-Royal").style.display = "none";
      document.getElementById("amenities-Premium").style.display = "none";
      document.getElementById("amenities-Business").style.display = "none";
    ...
    if(selectedamenities === "Royal"){
      document.getElementById("amenities-Royal").style.display = "block";
      document.getElementById("amenities-Luxury").style.display = "none";
      document.getElementById("amenities-Economy").style.display = "none";
      document.getElementById("amenities-Premium").style.display = "none";
      document.getElementById("amenities-Business").style.display = "none";
    ...
    if(selectedamenities === "Luxury"){
      document.getElementById("amenities-Luxury").style.display = "block";
      document.getElementById("amenities-Royal").style.display = "none";
      document.getElementById("amenities-Economy").style.display = "none";
      document.getElementById("amenities-Premium").style.display = "none";
      document.getElementById("amenities-Business").style.display = "none";
  ...
  const showferrygreenocean = () =>{
    // Disabling the select ferry btn and price tag and displaying ferry details
    document.getElementById("selectbtngreenocean").style.display = "none";
    document.getElementById("pricegreenocean").style.display = "none";
    document.getElementById("greenoceanferrydetail").style.display = "block";
    document.getElementById("selectbtn").style.display = "block";
    document.getElementById("selectbtn1").style.display = "block";
    document.getElementById("ferrydetail").style.display = "none";
  }
          ...
          <div className='row ferrydetail' style={{marginTop:"5%"}}> 
            ...
            <div className='container'>
              ...
              <div className='row'>
                ...
                <div className='col-5' id='selectbtn1' style={{display:"block"}}>
              ...
              <div className='row'>
                ...
                <div className='col-4 col-md-4' id='selectbtn' style={{display:"block"}}>
              ...
              <div className='row' id='ferrydetail' style={{display:"none"}}>
                <div className='container'>
                  <div className='row'>
                  ...
                  <div className='row' style={{marginTop:"2%"}}>
                    <div className="booking-details-amenities pad-3" id="amenities-Premium" style={{display:"none",marginBottom:"2%"}}>
                    ...
                    <div className="booking-details-amenities pad-3" id="amenities-Business" style={{display:"none",marginBottom:"2%"}}>
          ...
          <div className='row ferrydetail' style={{marginTop:"5%"}}> 
            ...
            <div className='container'>
                ...
                <div className='row'>
                    ...
                    <div className='col-5' id='pricegreenocean' style={{display:"block"}}>
                ...
                <div className='row'>
                  ...
                  <div className='col-4' id='selectbtngreenocean' style={{display:"block"}}>
                ...
                <div className='row' id='greenoceanferrydetail' style={{display:"none"}}>
                  <div className='container'>
                    <div className='row'>
                      <div className="slider" style={{marginLeft:"-3%"}}>
                        <button className="arrow arrow-left" onClick={goToPreviousImage}>
                    ...
                    <div className='row' style={{marginTop:"2%"}}>
                      <div className="booking-details-amenities pad-3" id="amenities-Economy" style={{display:"none", marginBottom:"2%"}}>
                      ...
                      <div className="booking-details-amenities pad-3" id="amenities-Luxury" style={{display:"none", marginBottom:"2%"}}>
                      ...
                      <div className="booking-details-amenities pad-3" id="amenities-Royal" style={{display:"none", marginBottom:"2%"}}>
