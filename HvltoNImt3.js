        ...
        <div className="container">
          <div className='row ferrydetail' style={{marginTop:"5%"}}> 
            ...
            <div className='container'>
              ...
              <div className='row'>
                <p className="font-size-smaller font-bold" style={{marginLeft:"-3%", textTransform:"uppercase"}}>Havelock→ Neil Island</p>
              </div>
