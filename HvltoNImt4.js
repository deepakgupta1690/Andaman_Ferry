...
const HvltoNImt4 = ({tripcount}) => {
  const showferry = () =>{
    // Disabling the select ferry btn and price tag and displaying ferry details
    document.getElementById("selectbtnnautikamt4").style.display = "none";
    document.getElementById("nautikapricemt4").style.display = "none";
    document.getElementById("ferrydetailmt4").style.display = "block";
    document.getElementById("selectbtngreenoceanmt4").style.display = "block";
    document.getElementById("pricegreenoceanmt4").style.display = "block";
    document.getElementById("greenoceanferrydetailmt4").style.display = "none";
  }

  const hideferry = () =>{
    // hiding the ferry details
    document.getElementById("selectbtnnautikamt4").style.display = "block";
    document.getElementById("nautikapricemt4").style.display = "block";
    document.getElementById("ferrydetailmt4").style.display = "none";
  }
  ...
  const showferrygreenocean = () =>{
    // Disabling the select ferry btn and price tag and displaying ferry details
    document.getElementById("selectbtngreenoceanmt4").style.display = "none";
    document.getElementById("pricegreenoceanmt4").style.display = "none";
    document.getElementById("greenoceanferrydetailmt4").style.display = "block";
    document.getElementById("selectbtnnautikamt4").style.display = "block";
    document.getElementById("nautikapricemt4").style.display = "block";
    document.getElementById("ferrydetailmt4").style.display = "none";
  }
          ...
          <div className='row ferrydetail' style={{marginTop:"5%"}}> 
            ...
            <div className='container'>
              ...
              <div className='row'>
                ...
                <div className='col-5' id='nautikapricemt4' style={{display:"block"}}>
              ...
              <div className='row'>
                ...
                <div className='col-4 col-md-4' id='selectbtnnautikamt4' style={{display:"block"}}>
              ...
              <div className='row' id='ferrydetailmt4' style={{display:"none"}}>
                <div className='container'>
                  <div className='row'>
                  ...
                  <div className='row' style={{marginTop:"2%"}}>
                    <div className="booking-details-amenities pad-3" id="amenities-Premiummt4" style={{display:"none", marginBottom:"2%"}}>
                      <h4> Amenities <strong className="font-italic">- <span className="seat-type brand-secondary">Premium</span> </strong></h4>
                      <ul className="amenities-Premiummt4 justify-content-between align-items-center flex-wrap no-padding no-margin-bottom active">
                    ...
                    <div className="booking-details-amenities pad-3" id="amenities-Businessmt4" style={{display:"none", marginBottom:"2%"}}>
                      <h4> Amenities <strong className="font-italic">- <span className="seat-type brand-secondary">Business</span> </strong></h4>
                      <ul className="amenities-Businessmt4 justify-content-between align-items-center flex-wrap no-padding no-margin-bottom active">
                        <li className="active am-pci">High-Speed Ferry</li>
                        <li className="active am-fr">Air Conditioned</li>
                        <li className="active am-ecs">Cafeteria</li>
                        <li className="active am-pv">Premium Seating</li>
          ...
          <div className='row ferrydetail' style={{marginTop:"5%"}}> 
            ...
            <div className='container'>
                ...
                <div className='row'>
                    ...
                    <div className='col-5' id='pricegreenoceanmt4' style={{display:"block"}}>
                ...
                <div className='row'>
                  ...
                  <div className='col-4' id='selectbtngreenoceanmt4' style={{display:"block"}}>
                ...
                <div className='row' id='greenoceanferrydetailmt4' style={{display:"none"}}>
                  <div className='container'>
                    <div className='row'>
                      <div className="slider" style={{marginLeft:"-3%"}}>
                        <button className="arrow arrow-left" onClick={goToPreviousImage}>
                    ...
                    <div className='row' style={{marginTop:"2%"}}>
                      <div className="booking-details-amenities pad-3" id="amenities-Economymt4" style={{display:"none", marginBottom:"2%"}}>
                        ...
                        <div className='row' style={{marginTop:"2%"}}>
                          <label style={{textAlign:"center"}}>
                            <button onClick={hidegreenoceanferry} style={{backgroundColor:"#f1f1f1", color:"#b4b4b4",fontWeight:"600",border:"none",width:"30%",height:"35px",borderRadius:"4px"}}>Close</button>
                            &nbsp;
                            <button onClick={Travellersdetail1} style={{backgroundColor:"#01b46c", color:"white",fontWeight:"600",border:"none",height:"33px",borderRadius:"4px",fontSize:"14px",paddingLeft:"5%",paddingRight:"5%"}}>Proceed with {selectedamenitie}</button>
                          </label>
                        </div>
                      </div>
                      <div className="booking-details-amenities pad-3" id="amenities-Luxurymt4" style={{display:"none", marginBottom:"2%"}}>
                      ...
                      <div className="booking-details-amenities pad-3" id="amenities-Royalmt4" style={{display:"none", marginBottom:"2%"}}>
