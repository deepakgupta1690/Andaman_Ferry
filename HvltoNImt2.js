              ...
              <div className='row' id='ferrydetailmt2' style={{display:"none"}}>
                <div className='container'>
                  ...
                  <div className='row' style={{marginTop:"2%"}}>
                    <div className="booking-details-amenities pad-3" id="amenities-Premiummt2" style={{display:"none"}}>
                    ...
                    <div className="booking-details-amenities pad-3" id="amenities-Businessmt2" style={{display:"none"}}>
