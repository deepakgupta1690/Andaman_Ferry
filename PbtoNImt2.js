...
const PbtoNImt2 = ({tripcount}) => {
  const showferry = () =>{
    // Disabling the select ferry btn and price tag and displaying ferry details
    document.getElementById("selectbtnnautikamt2").style.display = "none";
    document.getElementById("nautikapricemt2").style.display = "none";
    document.getElementById("ferrydetailmt2").style.display = "block";
    document.getElementById("selectbtngreenoceanmt2").style.display = "block";
    document.getElementById("pricegreenoceanmt2").style.display = "block";
    document.getElementById("greenoceanferrydetailmt2").style.display = "none";
  }

  const hideferry = () =>{
    // hiding the ferry details
    document.getElementById("selectbtnnautikamt2").style.display = "block";
    document.getElementById("nautikapricemt2").style.display = "block";
    document.getElementById("ferrydetailmt2").style.display = "none";
  }
  ...
  const Travellersdetail1 = () =>{
      ...
      if(tripcount === 2){
        ...
        document.getElementById("mt3").style.display = "block";
        document.getElementById("multitrip3").style.backgroundColor = "white";
      }
  }
  ...
  const amenities = (e) => {
    ...
    if(selectedamenities === "Business"){
      document.getElementById("amenities-Businessmt2").style.display = "block";
      document.getElementById("amenities-Premiummt2").style.display = "none";
      document.getElementById("amenities-Luxurymt2").style.display = "none";
      document.getElementById("amenities-Royalmt2").style.display = "none";
      document.getElementById("amenities-Economymt2").style.display = "none";
    }

    if(selectedamenities === "Premium"){
      document.getElementById("amenities-Premiummt2").style.display = "block";
      document.getElementById("amenities-Businessmt2").style.display = "none";
      document.getElementById("amenities-Luxurymt2").style.display = "none";
      document.getElementById("amenities-Royalmt2").style.display = "none";
      document.getElementById("amenities-Economymt2").style.display = "none";
    }
    ...
    if(selectedamenities === "Economy"){
      document.getElementById("amenities-Economymt2").style.display = "block";
      document.getElementById("amenities-Luxurymt2").style.display = "none";
      document.getElementById("amenities-Royalmt2").style.display = "none";
      document.getElementById("amenities-Premiummt2").style.display = "none";
      document.getElementById("amenities-Businessmt2").style.display = "none";
    ...
    if(selectedamenities === "Royal"){
      document.getElementById("amenities-Royalmt2").style.display = "block";
      document.getElementById("amenities-Luxurymt2").style.display = "none";
      document.getElementById("amenities-Economymt2").style.display = "none";
      document.getElementById("amenities-Premiummt2").style.display = "none";
      document.getElementById("amenities-Businessmt2").style.display = "none";
    ...
    if(selectedamenities === "Luxury"){
      document.getElementById("amenities-Luxurymt2").style.display = "block";
      document.getElementById("amenities-Royalmt2").style.display = "none";
      document.getElementById("amenities-Economymt2").style.display = "none";
      document.getElementById("amenities-Premiummt2").style.display = "none";
      document.getElementById("amenities-Businessmt2").style.display = "none";
  ...
  const showferrygreenocean = () =>{
    // Disabling the select ferry btn and price tag and displaying ferry details
    document.getElementById("selectbtngreenoceanmt2").style.display = "none";
    document.getElementById("pricegreenoceanmt2").style.display = "none";
    document.getElementById("greenoceanferrydetailmt2").style.display = "block";
    document.getElementById("selectbtnnautikamt2").style.display = "block";
    document.getElementById("nautikapricemt2").style.display = "block";
    document.getElementById("ferrydetailmt2").style.display = "none";
  }
          ...
          <div className='row ferrydetail' style={{marginTop:"5%"}}> 
            ...
            <div className='container'>
              ...
              <div className='row'>
                ...
                <div className='col-5' id='nautikapricemt2' style={{display:"block"}}>
              ...
              <div className='row'>
                ...
                <div className='col-4 col-md-4' id='selectbtnnautikamt2' style={{display:"block"}}>
                  <a className="book-btn" onClick={showferry}>Select Ferry</a>
                </div>
              </div>
              <div className='row'>
                <p className="font-size-smaller font-bold" style={{marginLeft:"-3%", textTransform:"uppercase"}}>PortBlair → Neil Island</p>
              </div>
              <div className='row' id='ferrydetailmt2' style={{display:"none"}}>
                <div className='container'>
                  <div className='row'>
                  ...
                  <div className='row' style={{marginTop:"2%"}}>
                    <div className="booking-details-amenities pad-3" id="amenities-Premiummt2" style={{display:"none", marginBottom:"2%"}}>
                      <h4> Amenities <strong className="font-italic">- <span className="seat-type brand-secondary">Premium</span> </strong></h4>
                      <ul className="amenities-Premiummt2 justify-content-between align-items-center flex-wrap no-padding no-margin-bottom active">
                    ...
                    <div className="booking-details-amenities pad-3" id="amenities-Businessmt2" style={{display:"none", marginBottom:"2%"}}>
                      <h4> Amenities <strong className="font-italic">- <span className="seat-type brand-secondary">Business</span> </strong></h4>
                      <ul className="amenities-Businessmt2 justify-content-between align-items-center flex-wrap no-padding no-margin-bottom active">
                        <li className="active am-pci">High-Speed Ferry</li>
                        <li className="active am-fr">Air Conditioned</li>
                        <li className="active am-ecs">Cafeteria</li>
                        <li className="active am-pv">Premium Seating</li>
          ...
          <div className='row ferrydetail' style={{marginTop:"5%"}}>
            ...
            <div className='container'>
                ...
                <div className='row'>
                    ...
                    <div className='col-5' id='pricegreenoceanmt2' style={{display:"block"}}>
                ...
                <div className='row'>
                  ...
                  <div className='col-4' id='selectbtngreenoceanmt2' style={{display:"block"}}>
                ...
                <div className='row' id='greenoceanferrydetailmt2' style={{display:"none"}}>
                  <div className='container'>
                    <div className='row'>
                      <div className="slider" style={{marginLeft:"-3%"}}>
                        <button className="arrow arrow-left" onClick={goToPreviousImage}>
                    ...
                    <div className='row' style={{marginTop:"2%"}}>
                      <div className="booking-details-amenities pad-3" id="amenities-Economymt2" style={{display:"none", marginBottom:"2%"}}>
                      ...
                      <div className="booking-details-amenities pad-3" id="amenities-Luxurymt2" style={{display:"none", marginBottom:"2%"}}>
                      ...
                      <div className="booking-details-amenities pad-3" id="amenities-Royalmt2" style={{display:"none", marginBottom:"2%"}}>
