                ...
                <div className='container'>
                  ...
                  <div className='row' style={{marginTop:"2%"}}>
                    ...
                    <div className="booking-details-amenities pad-3" id="amenities-Economymt2" style={{display:"none", marginBottom:"2%"}}>
                      ...
                      <ul className="amenities-Economymt2 justify-content-between align-items-center flex-wrap no-padding no-margin-bottom active">
                        <li className="active am-pci">High-Speed Ferry</li>
                        <li className="active am-fr">Air Conditioned</li>
                        <li className="active am-ecs">Cafeteria</li>
                        <li className="active am-pv">Premium Seating</li>
