...
const HvltoPbmt3 = ({tripcount}) => {
  const showferry = () =>{
    // Disabling the select ferry btn and price tag and displaying ferry details
    document.getElementById("selectbtnnautikamt3").style.display = "none";
    document.getElementById("nautikapricemt3").style.display = "none";
    document.getElementById("ferrydetailmt3").style.display = "block";
    document.getElementById("selectbtngreenoceanmt3").style.display = "block";
    document.getElementById("pricegreenoceanmt3").style.display = "block";
    document.getElementById("greenoceanferrydetailmt3").style.display = "none";
  }

  const hideferry = () =>{
    // hiding the ferry details
    document.getElementById("selectbtnnautikamt3").style.display = "block";
    document.getElementById("nautikapricemt3").style.display = "block";
    document.getElementById("ferrydetailmt3").style.display = "none";
  }
  ...
  const Travellersdetail1 = () =>{
      ...
      if(tripcount === 3){
        ...
        document.getElementById("mt4").style.display = "block";
        document.getElementById("multitrip4").style.backgroundColor = "white";
      }
  }
  ...
  const amenities = (e) => {
    ...
    if(selectedamenities === "Business"){
      document.getElementById("amenities-Businessmt3").style.display = "block";
      document.getElementById("amenities-Premiummt3").style.display = "none";
      document.getElementById("amenities-Luxurymt3").style.display = "none";
      document.getElementById("amenities-Royalmt3").style.display = "none";
      document.getElementById("amenities-Economymt3").style.display = "none";
    }

    if(selectedamenities === "Premium"){
      document.getElementById("amenities-Premiummt3").style.display = "block";
      document.getElementById("amenities-Businessmt3").style.display = "none";
      document.getElementById("amenities-Luxurymt3").style.display = "none";
      document.getElementById("amenities-Royalmt3").style.display = "none";
      document.getElementById("amenities-Economymt3").style.display = "none";
    }
    ...
    if(selectedamenities === "Economy"){
      document.getElementById("amenities-Economymt3").style.display = "block";
      document.getElementById("amenities-Luxurymt3").style.display = "none";
      document.getElementById("amenities-Royalmt3").style.display = "none";
      document.getElementById("amenities-Premiummt3").style.display = "none";
      document.getElementById("amenities-Businessmt3").style.display = "none";
    ...
    if(selectedamenities === "Royal"){
      document.getElementById("amenities-Royalmt3").style.display = "block";
      document.getElementById("amenities-Luxurymt3").style.display = "none";
      document.getElementById("amenities-Economymt3").style.display = "none";
      document.getElementById("amenities-Premiummt3").style.display = "none";
      document.getElementById("amenities-Businessmt3").style.display = "none";
    ...
    if(selectedamenities === "Luxury"){
      document.getElementById("amenities-Luxurymt3").style.display = "block";
      document.getElementById("amenities-Royalmt3").style.display = "none";
      document.getElementById("amenities-Economymt3").style.display = "none";
      document.getElementById("amenities-Premiummt3").style.display = "none";
      document.getElementById("amenities-Businessmt3").style.display = "none";
  ...
  const showferrygreenocean = () =>{
    // Disabling the select ferry btn and price tag and displaying ferry details
    document.getElementById("selectbtngreenoceanmt3").style.display = "none";
    document.getElementById("pricegreenoceanmt3").style.display = "none";
    document.getElementById("greenoceanferrydetailmt3").style.display = "block";
    document.getElementById("selectbtnnautikamt3").style.display = "block";
    document.getElementById("nautikapricemt3").style.display = "block";
    document.getElementById("ferrydetailmt3").style.display = "none";
  }
          ...
          {/* Nautika Lite ferry  */}
            <div className='container'>
              ...
              <div className='row'>
                ...
                <div className='col-5' id='nautikapricemt3' style={{display:"block"}}>
              ...
              <div className='row'>
                ...
                <div className='col-4 col-md-4' id='selectbtnnautikamt3' style={{display:"block"}}>
                  <a className="book-btn" onClick={showferry}>Select Ferry</a>
                </div>
              </div>
              <div className='row'>
                <p className="font-size-smaller font-bold" style={{marginLeft:"-3%", textTransform:"uppercase"}}>Havelock→ PortBlair </p>
              </div>
              <div className='row' id='ferrydetailmt3' style={{display:"none"}}>
                <div className='container'>
                  <div className='row'>
                  ...
                  <div className='row' style={{marginTop:"2%"}}>
                    <div className="booking-details-amenities pad-3" id="amenities-Premiummt3" style={{display:"none", marginBottom:"2%"}}>
                      <h4> Amenities <strong className="font-italic">- <span className="seat-type brand-secondary">Premium</span> </strong></h4>
                      <ul className="amenities-Premiummt3 justify-content-between align-items-center flex-wrap no-padding no-margin-bottom active">
                      ...
                      <div className='row' style={{marginTop:"2%"}}>
                        <label style={{textAlign:"center"}}>
                          <button onClick={hideferry} style={{backgroundColor:"#f1f1f1", color:"#b4b4b4",fontWeight:"600",border:"none",width:"30%",height:"35px",borderRadius:"4px"}}>Close</button>
                          &nbsp;
                    ...
                    <div className="booking-details-amenities pad-3" id="amenities-Businessmt3" style={{display:"none", marginBottom:"2%"}}>
                      <h4> Amenities <strong className="font-italic">- <span className="seat-type brand-secondary">Business</span> </strong></h4>
                      <ul className="amenities-Businessmt3 justify-content-between align-items-center flex-wrap no-padding no-margin-bottom active">
                        <li className="active am-pci">High-Speed Ferry</li>
                        <li className="active am-fr">Air Conditioned</li>
                        <li className="active am-ecs">Cafeteria</li>
                        <li className="active am-pv">Premium Seating</li>
          ...
          {/* Green Ocean ferry  */}
            <div className='container'>
                ...
                <div className='row'>
                    ...
                    <div className='col-5' id='pricegreenoceanmt3' style={{display:"block"}}>
                ...
                <div className='row'>
                  ...
                  <div className='col-4' id='selectbtngreenoceanmt3' style={{display:"block"}}>
                ...
                <div className='row' id='greenoceanferrydetailmt3' style={{display:"none"}}>
                  <div className='container'>
                    <div className='row'>
                      <div className="slider" style={{marginLeft:"-3%"}}>
                        <button className="arrow arrow-left" onClick={goToPreviousImage}>
                    ...
                    <div className='row' style={{marginTop:"2%"}}>
                      <div className="booking-details-amenities pad-3" id="amenities-Economymt3" style={{display:"none", marginBottom:"2%"}}>
                      ...
                      <div className="booking-details-amenities pad-3" id="amenities-Luxurymt3" style={{display:"none", marginBottom:"2%"}}>
                      ...
                      <div className="booking-details-amenities pad-3" id="amenities-Royalmt3" style={{display:"none", marginBottom:"2%"}}>
