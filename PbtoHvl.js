            ...
            <div className='container'>
                ...
                <div className='row' id='greenoceanferrydetail' style={{display:"none"}}>
                  <div className='container'>
                    ...
                    <div className='row' style={{marginTop:"2%"}}>
                      <div className="booking-details-amenities pad-3" id="amenities-Economy" style={{display:"none"}}>
                      ...
                      <div className="booking-details-amenities pad-3" id="amenities-Luxury" style={{display:"none"}}>
                      ...
                      <div className="booking-details-amenities pad-3" id="amenities-Royal" style={{display:"none"}}>
