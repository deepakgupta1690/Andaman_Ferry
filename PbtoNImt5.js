            ...
            <div className='container'>
                ...
                <div className='row' id='greenoceanferrydetailmt5' style={{display:"none"}}>
                  <div className='container'>
                    ...
                    <div className='row' style={{marginTop:"2%"}}>
                      <div className="booking-details-amenities pad-3" id="amenities-Economymt5" style={{display:"none"}}>
                      ...
                      <div className="booking-details-amenities pad-3" id="amenities-Luxurymt5" style={{display:"none"}}>
                      ...
                      <div className="booking-details-amenities pad-3" id="amenities-Royalmt5" style={{display:"none"}}>
